...
@property (nonatomic, strong, readonly) FBSDKLoginButton *loginButton;
@end
...
- (void)setupView {
    ...
    // Decoration.
    [self.gradientView setImage:[UIImage imageNamed:@"background.png"]];
    ...
    [self.overlayTitle setFont:[UIFont fontWithName:@"Helvetica" size:32.0]];
...
- (void)addAllConstraints {
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(_overlayTitle, _pageControl,_loginButton);
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_overlayTitle(40)]" options:0 metrics:metrices views:views]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"[_overlayTitle(280)]" options:0 metrics:metrices views:views]];
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:_overlayTitle attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterY multiplier:1 constant:0.0]];
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:_overlayTitle attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterX multiplier:1 constant:0.0]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_loginButton(40)]-(50)-|" options:0 metrics:metrices views:views]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-[_loginButton]-|" options:0 metrics:metrices views:views]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_pageControl(40)]-(100)-|" options:0 metrics:metrices views:views]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-[_pageControl]-|" options:0 metrics:metrices views:views]];
...
- (void)setOverlayTitle {
    ...
    [self.overlayTitle setText:@"Super CreationZ"];
  }
